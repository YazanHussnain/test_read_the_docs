...
.. figure:: ../images/mmu_major_blocks.png
   :name: **Figure 1:** Major Blocks in CVA6 MMU SV32
   :align: center
   :scale: 50%
   :alt: something added
...
**Table 1:** CVA6 TLB Input Output Signals
...
.. figure:: ../images/in_out_tlb.png
   :name: **Figure 1:** Inputs and Outputs of CVA6 TLB
   :align: center
   :scale: 50%
   :alt: something added

**Figure 1:** Inputs and Outputs of CVA6 TLB
...
**Table 2:** SV32 TLB Update Struct
...
.. figure:: ../images/cva6_tlb_entry.png
   :name: **Figure 2:** Fields in CVA6 TLB entry
   :align: center
   :width: 60%
   :alt: something added

**Figure 2:** Fields in CVA6 TLB entry
...
.. figure:: ../images/cva6_tlb_hit.png
   :name: **Figure 3:** Block diagram of CVA6 TLB hit or miss
   :align: center
   :width: 60%
   :alt: something added

**Figure 3:** Block diagram of CVA6 TLB hit or miss
...
.. figure:: ../images/sfence_vaddr_asid.png
   :name: **Figure 4:** Invalidate TLB entry if ASID and virtual address match
   :align: center
   :width: 60%
   :alt: something added

**Figure 4:** Invalidate TLB entry if ASID and virtual address match
...
.. figure:: ../images/sfence_x0_x0.png
   :name: **Figure 5:** Invalidate TLB entry for matching ASIDs
   :align: center
   :width: 60%
   :alt: something added

**Figure 5:** Invalidate all tlb entries
...
.. figure:: ../images/sfence_vaddr_x0.png
   :name: **Figure 6:** Invalidate all TLB entries if both source register specifiers are x0
   :align: center
   :width: 60%
   :alt: something added

**Figure 6:** Invalidate TLB entry with matching virtual address for all address spaces
...
.. figure:: ../images/sfence_x0_asid.png
   :name: **Figure 7:** Invalidate TLB entry with matching virtual address for all address spaces
   :align: center
   :width: 60%
   :alt: something added

**Figure 7:** Invalidate TLB entry for matching ASIDs 
...
.. figure:: ../images/plru_tree_indexing.png
   :name: **Figure 8:** PLRU Tree Indexing
   :align: center
   :width: 60%
   :alt: something added

**Figure 8:** PLRU Tree Indexing
...
.. figure:: ../images/update_tree.png
   :name: **Figure 9:** Promote Entry to be MRU
   :align: center
   :width: 60%
   :alt: something added

**Figure 9:** Promote Entry to be MRU
...
.. figure:: ../images/replacement_entry.png
   :name: **Figure 10:** Possible path traverse for entry selection for replacement
   :align: center
   :width: 60%
   :alt: something added

**Figure 10:** Possible path traverse for entry selection for replacement
...
**Table 4:** Entry Selection for Reaplacement
...
.. figure:: ../images/shared_tlb.png
   :name: **Figure 9:** CVA6 Shared TLB Structure
   :align: center
   :width: 60%
   :alt: something added
...
.. figure:: ../images/shared_tlb_set.png
   :name: **Figure 9:** Set opted for lookup in shared TLB
   :align: center
   :width: 60%
   :alt: something added
...
.. figure:: ../images/LZC.png
   :name: **Figure 9:** Replacement of First invalid entry.
   :align: center
   :width: 60%
   :alt: something added
...
.. figure:: ../images/RR.png
   :name: **Figure 9:** Entry selection for replacement using LFSR
   :align: center
   :width: 60%
   :alt: something added
...
.. figure:: ../images/ptw_in_out.png
   :name: **Figure 9:** Input and Outputs of Page Table Walker
   :align: center
   :width: 60%
   :alt: something added
...
.. figure:: ../images/ptw_state_diagram.png
   :name: **Figure 9:** State Machine Diagram of CVA6 PTW
   :align: center
   :width: 60%
   :alt: something added
...
.. figure:: ../images/ptw_idle.png
   :name: **Figure 9:** Address of Desired PTE at Level 1
   :align: center
   :width: 60%
   :alt: something added
...
.. figure:: ../images/ptw_pte_1.png
   :name: **Figure 9:** Address of Desired PTE at Level 2
   :align: center
   :width: 60%
   :alt: something added
...
.. figure:: ../images/ptw_iptw.png
   :name: **Figure 9:** Address of Desired PTE at Level 3
   :align: center
   :width: 60%
   :alt: something added
...
.. figure:: ../images/ptw_dptw.png
   :name: **Figure 9:** Address of Desired PTE at Level 4
   :align: center
   :width: 60%
   :alt: something added
...
.. figure:: ../images/ptw_dptw_s.png
   :name: **Figure 9:** Address of Desired PTE at Level5
   :align: center
   :width: 60%
   :alt: something added
...
.. figure:: ../images/ptw_mis_sup.png
   :name: **Figure 9:** Address of Desired PTE at Level6
   :align: center
   :width: 60%
   :alt: something added
...
.. figure:: ../images/ptw_pte_flowchart.png
   :name: **Figure 9:** Address of Desired PTE at Level 7
   :align: center
   :width: 60%
   :alt: something added
